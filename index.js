        ...
        if (command == bot_prefix + 'help') {
            try {
                ...
                if (bot_command_help.length < 1) {
                    // General
                    addhelp('avatar', bot_prefix + 'avatar (user)', "View a user's discord avatar", 'user: User you want to view (Has to be @user)', '!avatar @Tienei#0000')
                    addhelp('changelog', bot_prefix + 'changelog', 'View update and fix for the bot', 'None', '!changelog')
                    addhelp('help', bot_prefix + 'help (command)', 'Get a full command list or view a specific command help', 'command: Command help you wanted to see', '!help osu')
                    addhelp('ping', bot_prefix + 'ping', 'Ping Bancho (probably making Bancho mad sometimes lol)\n100ms: Good\n200ms: OK\n300ms: Bad\n600ms: Pretty bad', 'None', '!ping')
                    addhelp('report', bot_prefix + 'report (error)', 'Report an error or bug to the owner', 'error: Type any error or bug you found', '!report osu is broken')
                    addhelp('suggestion', bot_prefix + 'suggestion (suggestion)', 'Suggesting an idea for the bot to the owner', 'error: Type any error or bug you found', '!report osu is broken')
                    addhelp('bot', bot_prefix + 'bot', 'Get invitation of the bot', 'None', '!bot')
                    addhelp('checkbot', bot_prefix + 'checkbot', 'Check the compatibility of the bot to the server permissions', 'None', '!checkbot')
                    addhelp('prefix',bot_prefix + 'prefix (prefix)', 'Change the prefix for the entire server','prefix: The prefix you wanted','!prefix >')
                    // Easter Egg
                    addhelp('ee', bot_prefix + 'ee', 'View how many easter eggs you have', 'None', '!ee')
                    // Custom command
                    addhelp('customcmd', bot_prefix + 'customcmd (action) (command)', 'Set a custom commands (Required Administration)', 'action: ``add`` ``list`` ``remove``\ncommand: Set a command you liked (do ``!help definedvar`` for more information)', '!customcmd add !hi Hello $0 and welcome to {server.name}')
                    // Fun
                    addhelp('hug', bot_prefix + 'hug (user)', 'Hug someone', 'user: The name of the user (Discord)', '!hug Tienei')
                    addhelp('cuddle', bot_prefix + 'cuddle (user)', 'Cuddle someone', 'user: The name of the user (Discord)', '!cuddle Tienei')
                    addhelp('slap', bot_prefix + 'slap (user)', 'Slap someone', 'user: The name of the user (Discord)', '!slap Tienei')
                    addhelp('kiss', bot_prefix + 'kiss (user)', 'Kiss someone (best not to kiss in public ;) )', 'user: The name of the user (Discord)', '!kiss Tienei')
                    addhelp('pat', bot_prefix + 'pat (user)', 'Pat someone', 'user: The name of the user (Discord)', '!pat Tienei')
                    // Osu
                    addhelp('osu', bot_prefix + 'osu (username) (options)', 'Get an osu!Standard profile', 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)\nDetailed `(-d)`: Get all the details of the player `(no param)`\nRank `(-rank)`: Get an osu!Standard profile by rank\nTop Skills `(-ts)`: Calculate player skill using bot formula', '!osu Tienei -d')
                    addhelp('taiko', bot_prefix + 'taiko (username)', 'Get an osu!Taiko profile', 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!taiko Tienei')
                    addhelp('ctb', bot_prefix + 'ctb (username)', 'Get an osu!Catch the beat profile', 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!ctb Tienei')
                    addhelp('mania', bot_prefix + 'mania (username)', 'Get an osu!Mania profile', 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!mania Tienei')
                    addhelp('osucard', bot_prefix + 'sucard (username)', 'Generate an osu!card (Just for fun)','username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!osucard Tienei')
                    addhelp('taikocard', bot_prefix + 'taikocard (username)', 'Generate a taiko!card (Just for fun)','username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!taikocard Tienei')
                    addhelp('ctbcard', bot_prefix + 'ctbcard (username)', 'Generate a ctb!card (Just for fun)','username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!ctbcard Tienei')
                    addhelp('maniacard', bot_prefix + 'maniacard (username)', 'Generate a mania!card (Just for fun)','username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!maniacard Tienei')
                    addhelp('osustatus', bot_prefix + 'osustatus', 'Check osu current status (Information from @osustatus twitter)','None', '!osustatus')
                    addhelp('osutop', bot_prefix + 'osutop (username) (options)', "View a player's osu!Standard top play", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)\nSpecific Play `(-p)`: Get a specific play from top 100 `(Number)`\nRecent Play `(-r)`: Get a top recent play from top 100 `(No param)`\nMods Play `(-m)`: Get a top mods play from top 100 `(Shorten mods)`\nGreater than `(-g)`: Get number of plays greater than certain amount of pp (Number)\nPage `(-page)`: Get top 100 in a form of pages `(No param)`\nSearch `(-search)`: Search for a specific play in top 100', '!osutop Tienei -m HDHR')
                    addhelp('taikotop', bot_prefix + 'taikotop (username) (options)', "View a player's osu!Taiko top play", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)\nSpecific Play `(-p)`: Get a specific play from top 100 `(Number)`\nRecent Play `(-r)`: Get a top recent play from top 100 `(No param)`\nMods Play `(-m)`: Get a top mods play from top 100 `(Shorten mods)`\nGreater than `(-g)`: Get number of plays greater than certain amount of pp (Number)\nPage `(-page)`: Get top 100 in a form of pages `(No param)`\nSearch `(-search)`: Search for a specific play in top 100', '!taikotop Tienei -p 8')
                    addhelp('ctbtop', bot_prefix + 'ctbtop (username) (options)', "View a player's osu!Catch the beat top play", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)\nSpecific Play `(-p)`: Get a specific play from top 100 `(Number)`\nRecent Play `(-r)`: Get a top recent play from top 100 `(No param)`\nMods Play `(-m)`: Get a top mods play from top 100 `(Shorten mods)`\nGreater than `(-g)`: Get number of plays greater than certain amount of pp (Number)\nPage `(-page)`: Get top 100 in a form of pages `(No param)`\nSearch `(-search)`: Search for a specific play in top 100', '!ctbtop Tienei -p 9')
                    addhelp('maniatop', bot_prefix + 'maniatop (username) (options)', "View a player's osu!Mania top play", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)\nSpecific Play `(-p)`: Get a specific play from top 100 `(Number)`\nRecent Play `(-r)`: Get a top recent play from top 100 `(No param)`\nMods Play `(-m)`: Get a top mods play from top 100 `(Shorten mods)`\nGreater than `(-g)`: Get number of plays greater than certain amount of pp (Number)\nPage `(-page)`: Get top 100 in a form of pages `(No param)`\nSearch `(-search)`: Search for a specific play in top 100', '!maniatop Tienei -p 4')
                    addhelp('osutrack', bot_prefix + 'osutrack (username)', "Track a player's osu!Standard top 50 (Required Administration)", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!osutrack Tienei')
                    addhelp('osutracklist', bot_prefix + 'osutracklist', 'Get a list of player being tracked in the channel', 'None', '!osutracklist')
                    addhelp('untrack', bot_prefix + 'untrack (username)', 'Untrack a player from the database (Required Administration)', 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!untrack Tienei')
                    addhelp('recent', bot_prefix + '[recent|r] (username) (options)', "Get player's most recent play", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)\nRecent Best `(-b)`: Get player most recent best from top 100 `(No param)`\nStandard `(-Standard)`\nTaiko `(-Taiko)`\nCTB `(-CTB)`\nMania `(-Mania)`', '!r Tienei -b')
                    addhelp('compare', bot_prefix + '[compare|c] (username) ', 'Compare to the last play in the chat', 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)\nPrevious Play `(-p)`: Get a previous play mentioned in the chat `(Number)`', '!c Tienei')
                    addhelp('osuset', bot_prefix + 'osuset (username)', 'Link your profile to an osu! player', 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!osuset Tienei')
                    addhelp('osuavatar', bot_prefix + 'osuavatar (username)', "Get player's osu! avatar", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!osuavatar Tienei')
                    addhelp('osusig', bot_prefix + 'osusig (username)', "Generate a signature of a player's profile", 'username: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!osusig Tienei')
                    addhelp('map', bot_prefix + '[map|m] (options)', 'Get details info of the map of the last play in the server', 'Mods: details info of the map with mods `(Shorten mods)`', '!m HDDT')
                    addhelp('topglobal', bot_prefix + 'topglobal', 'Get a list of top 50 osu!Standard player', '', '!topglobal')
                    addhelp('topcountry', bot_prefix + 'topcountry (country code)', 'Get a list of top 50 osu!Standard player of a country', 'country code: You can see a list right here: https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes (Look at ISO 3166-1, Alpha-2 code)', '!topcountry US')
                    addhelp('calcpp', bot_prefix + 'calcpp (map id) (mods) (acc) (combo) (miss)', "Calculate a play's pp", '**Needs all options to be calculated**', '!calcpp 1157868 nomod 100 1642 0')
                    addhelp('scores', bot_prefix + 'scores (map link) (username)', "Get player's play on a specific map", 'Map link: Just get a beatmap link\nusername: osu!username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!scores https://osu.ppy.sh/b/1157868 Cookiezi')
                    addhelp('acc', bot_prefix + 'acc (300) (100) (50) (miss)', 'Accuracy calculator', '**Needs all options to be calculated**', '!acc 918 23 2 0')
                    addhelp('rec', bot_prefix + 'rec', 'Recommend you an osu beatmap', 'None', '!rec')
                    addhelp('leaderboard', bot_prefix + 'leaderboard', 'Get a list of top player in the server\nNote: The player stats will only be updated if the you type **!osu** or a specific player **!osu (player name)** only if they in the server', 'None', '!leaderboard')
                    // Akatsuki
                    addhelp('akatsuki', bot_prefix + 'akatsuki (username) (options)', 'Get an Akatuski Standard profile', 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)\nDetails `(-d)`: Get all the details of the player `(no param)`', '!akatsuki Tienei -d')
                    addhelp('akatr', bot_prefix + 'akatr (username)', "Get player's most recent play", 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!akatr Tienei')
                    addhelp('akattop', bot_prefix + 'akattop (username) (options)', "View a player's Akatsuki Standard top play", 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)\nSpecific Play `(-p)`: Get a specific play from top 100 `(Number)`\nMods Play `(-m)`: Get a top mods play from top 100 `(Shorten mods)`', '!akattop Tienei -p 8')
                    addhelp('akatavatar', bot_prefix + 'akatavatar (username)', "Get player's Akatsuki avatar", 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!akatavatar Tienei')
                    addhelp('akatsukiset', bot_prefix + 'akatsukiset (username)', 'Link your profile to an Akatsuki player', 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!akatsukiset RelaxTiny')
                    addhelp('rxakatsuki', bot_prefix + 'rxakatsuki (username) (options)', 'Get a Relax Akatuski Standard profile', 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)\nDetails `(-d)`: Get all the details of the player `(no param)`', '!akatsuki Tienei -d')
                    addhelp('rxakatr', bot_prefix + 'rxakatr (username)', "Get player's most recent play", 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!akatr Tienei')
                    addhelp('rxakattop', bot_prefix + 'rxakattop (username) (options)', "View a player's Relax Akatsuki Standard top play", 'username: Akatsuki username of the player (Space replaced with "_" or just use quotation mark ``"``)\nSpecific Play `(-p)`: Get a specific play from top 100 `(Number)`\nMods Play `(-m)`: Get a top mods play from top 100 `(Shorten mods)`', '!akattop Tienei -p 8')
                    addhelp('calcrxpp', bot_prefix + 'calrxcpp (map id) (mods) (acc) (combo) (miss)', "Calculate a play's relax pp (Akatsuki)", '**Needs all options to be calculated**', '!calcpp 1157868 nomod 100 1642 0')
                    // Ripple
                    addhelp('ripple', bot_prefix + 'ripple (username) (options)', 'Get an  Ripple Standard profile', 'username: Ripple username of the player (Space replaced with "_" or just use quotation mark ``"``)\nDetailed `(-d)`: Get all the detailed of the player `(no param)`', '!ripple Tienei -d')
                    addhelp('rippler', bot_prefix + 'rippler (username)', "Get player's most recent play", 'username: Ripple username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!rippler Tienei')
                    addhelp('rippletop', bot_prefix + 'rippletop (username) (options)', "View a player's Ripple Standard top play", 'username: Ripple username of the player (Space replaced with "_" or just use quotation mark ``"``)\nSpecific Play `(-p)`: Get a specific play from top 100 `(Number)`\nMods Play `(-m)`: Get a top mods play from top 100 `(Shorten mods)`', '!rippletop Tienei -p 8')
                    addhelp('rippleavatar', bot_prefix + 'rippleavatar (username)', "Get player's Ripple avatar", 'username: Ripple username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!rippleavatar Tienei')
                    addhelp('rippleset', bot_prefix + 'rippleset (username)', 'Link your profile to a Ripple player', 'username: Ripple username of the player (Space replaced with "_" or just use quotation mark ``"``)', '!rippleset RelaxTiny')
                    // Others
